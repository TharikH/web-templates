...
<body>
    <div class=" load d-flex justify-content-center h-100" id="load">
    ...
    <div class="content" id="content">
        ...
        <img class="img animated zoomIn wow slow" id="photo" src="https://myhealthchampion.com/wp-content/uploads/2019/09/Blog-Featured-Image-1400x1200-copy.jpg" alt="">
        ...
        <div class="container-fluid wow animated fadeInUp slow" id="about" name="about">
            <!-- Jumbotron -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 bounceInLeft animated wow slow">
                ...
                <div class="col-4 bounceInUp animated wow slow">
                    <div class="card card-cascade narrower ">
                ...
                <div class="col-4 bounceInRight animated wow slow">
                    <div class="card card-cascade narrower ">
